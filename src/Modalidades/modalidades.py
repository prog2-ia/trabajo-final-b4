...
class Ciclismo(Modalidad):
    ...
    def equipamiento(self) -> list[str]:
        return ['Casco homologado','Bidón de agua','Ropa reflectante',]
...
class Senderismo(Modalidad):
    ...
    def equipamiento(self) -> list[str]:
        return ['Botas de montaña','Mochila','Bastones de trekking','Mapa o GPS','Agua y comida']
